...
[![Tests](https://img.shields.io/badge/tests-189%20passing-2EA043?style=for-the-badge)](#-phát-triển--đóng-góp)
...
Requires Windows 10/11 and the built-in PowerShell 5.1. No installation, no dependencies. Ships with a **189-case regression suite** that builds its own sandbox in `%TEMP%`.
...
| Quy mô mã nguồn | |
|:---|---:|
| `ZaloCleanup.ps1` | 2.994 dòng · 83 hàm |
| `ZaloCleanup.Tests.ps1` | 1.082 dòng · **189 phép thử** |
...
Built with 💙 PowerShell · 🪟 Windows · 🔐 SHA-256 · 🧪 189 tests
